...
const PageLoader = () => <LoadingFallback message="Chargement de la page..." />;
...
const TrainerLicensesManagementPage = lazy(() =>
  import('@/pages/Formateur/TrainerLicensesManagementPage')
);
...
function AppContent() {
  ...
  const isPwaMode =
    ...
    new URLSearchParams(location.search).get('mode') === 'pwa';
        ...
        <Routes>
          <Route path="/" element={<Layout pwaMode={true} />}>
            ...
            <Route
              path="taches"
              element={
                <ProtectedRoute roles={[USER_ROLES.LEARNER, USER_ROLES.TRAINER, USER_ROLES.ADMIN]}>
                  <TaskListPage />
                </ProtectedRoute>
              }
            />
            <Route
              path="questionnaire/:taskId"
              element={
                <ProtectedRoute roles={[USER_ROLES.LEARNER, USER_ROLES.TRAINER, USER_ROLES.ADMIN]}>
            ...
            <Route
              ...
              element={
                <ProtectedRoute roles={[USER_ROLES.LEARNER, USER_ROLES.TRAINER, USER_ROLES.ADMIN]}>
                  <ExerciseStepsPreviewPage />
                </ProtectedRoute>
              }
            />
            <Route
              path="tache/:taskId/version/:versionId"
              element={
                <ProtectedRoute roles={[USER_ROLES.LEARNER, USER_ROLES.TRAINER, USER_ROLES.ADMIN]}>
                  <ExercisePage />
                </ProtectedRoute>
            ...
            <Route
              path="formateur"
              element={
                <ProtectedRoute roles={[USER_ROLES.TRAINER, USER_ROLES.ADMIN]}>
            ...
            <Route
              path="mon-suivi"
              element={
                <ProtectedRoute roles={[USER_ROLES.LEARNER]}>
                  <LearnerProgressPage />
                </ProtectedRoute>
              }
            />
            <Route
              path="compte-apprenant"
              element={
                <ProtectedRoute roles={[USER_ROLES.LEARNER]}>
                  <LearnerAccountPage />
                </ProtectedRoute>
            ...
            />
            <Route
              path="compte-formateur"
              element={
                <ProtectedRoute roles={[USER_ROLES.TRAINER]}>
                  <TrainerAccountPage />
                </ProtectedRoute>
              }
            />
    ...
    <Suspense fallback={<PageLoader />}>
      <Routes>
        <Route path="/" element={<Layout />}>
          ...
          <Route
            path="admin/preview/tache/:taskId/version/:versionId"
            element={
          ...
          />
          <Route
            path="contributeur/nouvelle-contribution"
            element={
              <ProtectedRoute roles={[USER_ROLES.ADMIN, USER_ROLES.CONTRIBUTOR]}>
                <NewContribution />
              </ProtectedRoute>
          ...
          />
          <Route
            path="contributeur/questionnaire"
            element={
              <ProtectedRoute roles={[USER_ROLES.ADMIN, USER_ROLES.CONTRIBUTOR]}>
          ...
          />
          <Route
            path="contributeur/mes-contributions"
            element={
              <ProtectedRoute roles={[USER_ROLES.ADMIN, USER_ROLES.CONTRIBUTOR]}>
                <MyContributions />
              </ProtectedRoute>
          ...
          />
          <Route
            path="contributeur/liste-demandes"
            element={
              <ProtectedRoute roles={[USER_ROLES.ADMIN, USER_ROLES.CONTRIBUTOR]}>
                <ExerciseRequestsList />
              </ProtectedRoute>
            }
          />
          <Route
            path="contributeur/bibliotheque"
            element={
              <ProtectedRoute roles={[USER_ROLES.ADMIN, USER_ROLES.CONTRIBUTOR]}>
                <ContributorImageLibrary />
              </ProtectedRoute>
            }
          />
          <Route
            path="contributeur/ventes"
            element={
              <ProtectedRoute roles={[USER_ROLES.ADMIN, USER_ROLES.CONTRIBUTOR]}>
                <ContributorSalesHistory />
              </ProtectedRoute>
            }
          />
          <Route
            path="contributeur/profil"
            element={
              <ProtectedRoute roles={[USER_ROLES.ADMIN, USER_ROLES.CONTRIBUTOR]}>
          ...
          />
          <Route
            path="formateur/acheter-licences"
            element={
              <ProtectedRoute roles={[USER_ROLES.TRAINER]}>
                <BuyLicensesPage />
              </ProtectedRoute>
          ...
          />
          <Route
            path="formateur/gestion-licences"
            element={
              <ProtectedRoute roles={[USER_ROLES.TRAINER]}>
                <TrainerLicensesManagementPage />
              </ProtectedRoute>
            }
          />
          <Route
