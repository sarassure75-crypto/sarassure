...
export const useAdminView = () => {
  ...
  const navigateToView = useCallback(
    (view, stateUpdates = {}) => {
      ...
      if (stateUpdates.selectedVersion !== undefined)
        setSelectedVersion(stateUpdates.selectedVersion);
      if (stateUpdates.selectedStep !== undefined) setSelectedStep(stateUpdates.selectedStep);
      if (stateUpdates.editingStepIndex !== undefined)
        setEditingStepIndex(stateUpdates.editingStepIndex);
      if (stateUpdates.isEditingTask !== undefined) setIsEditingTask(stateUpdates.isEditingTask);
      if (stateUpdates.isEditingVersion !== undefined)
        setIsEditingVersion(stateUpdates.isEditingVersion);
