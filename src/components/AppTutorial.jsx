...
import { X, ChevronLeft, ChevronRight, Smartphone, MousePointerClick, Keyboard, CheckCircle, Play } from 'lucide-react';
...
const TutorialStep = ({ step, isActive }) => (
  ...
  >
    <Card className={`h-full ${isActive ? 'border-2 border-primary shadow-xl' : 'border-gray-200'}`}>
        ...
        {step.demoImage && (
          ...
          >
            <div className="text-gray-500 text-sm">
              [Capture d'écran démo : {step.demoImage}]
            </div>
          </motion.div>
        )}
      </CardContent>
