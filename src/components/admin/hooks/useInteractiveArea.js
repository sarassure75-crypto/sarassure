import { useState, useEffect, useCallback } from 'react';
    ...
    export const useInteractiveArea = (initialArea, imageDimensions) => {
        ...
        const getMousePositionOnImage = useCallback((e, imageRef) => {
        ...
        const handleMouseDown = useCallback((e, imageRef) => {
        ...
        const handleResizeMouseDown = useCallback((e, handleName, imageRef) => {
            e.stopPropagation();
            setIsResizing(true);
