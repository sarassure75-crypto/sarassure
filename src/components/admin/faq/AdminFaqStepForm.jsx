    ...
    <div className="p-3 border rounded-md space-y-3 bg-muted/50 mb-3">
      ...
      <div className="grid grid-cols-2 gap-3">
        <div>
          ...
          <Select
            value={localStep.image_id || '_none_'}
            onValueChange={(value) => handleSelectChange('image_id', value)}
          >
          ...
          {currentImageInfo && (
            <img
              src={getImageUrl(currentImageInfo.file_path)}
              alt={currentImageInfo.description}
              className="mt-1 h-10 w-10 object-contain rounded border"
            />
          )}
        </div>
        <div>
          ...
          <Select
            value={localStep.pictogram_id || '_none_'}
            onValueChange={(value) => handleSelectChange('pictogram_id', value)}
          >
          ...
          {currentPictogramInfo && (
            <img
              src={getImageUrl(currentPictogramInfo.file_path)}
              alt={currentPictogramInfo.description}
              className="mt-1 h-8 w-8 object-contain rounded border"
            />
          )}
        </div>
      </div>
