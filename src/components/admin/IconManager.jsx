...
const IconManager = ({ onSelectIcon }) => {
  ...
  const copyIconReference = (iconName, libraryId) => {
    const reference = `${libraryId}-${iconName}`;
        ...
        <CardContent className="space-y-6">
          ...
          <div>
            <label className="text-sm font-semibold mb-2 block">
              🔍 Rechercher dans {currentLibrary?.name}
            </label>
            <div className="relative">
              <Search className="absolute left-3 top-3 h-4 w-4 text-gray-400" />
              <Input
                placeholder="Tapez un mot clé (ex: phone, home, star)..."
                value={searchTerm}
          ...
          <Card className="bg-blue-50 border-blue-200">
            <CardContent className="pt-4">
              ...
              <ul className="text-xs text-gray-700 space-y-1">
                <li>1. Sélectionnez une bibliothèque d'icônes</li>
                <li>2. Recherchez une icône par mot clé</li>
                <li>3. Cliquez sur une icône pour copier sa référence</li>
                <li>4. Utilisez la référence dans QuestionnaireCreation ou AdminQuestionnaireEditor</li>
              </ul>
              <p className="text-xs text-gray-600 mt-3 font-mono bg-white p-2 rounded border border-blue-200">
                Format: <code>library-iconName</code> (ex: <code>fa-Heart</code>)
              </p>
            </CardContent>
          </Card>
