                          ...
                          <>
                            ...
                            <TableCell className="text-right">
                              <Button
                                variant="ghost"
                                size="icon"
                                onClick={() => handleSaveUser(learner.id)}
                              >
                          ...
                          <>
                              ...
                              <div className="flex items-center gap-2">
                                ...
                                {learner.learner_code && (
                                  <Button
                                    ...
                                    size="icon"
                                    className="h-7 w-7"
                                    onClick={() => handleCopy(learner.learner_code)}
                                  >
                            ...
                            <TableCell className="text-right space-x-1">
                              <Button
                                variant="ghost"
                                size="icon"
                                onClick={() => handleEditUser(learner)}
                              >
                              ...
                              <AlertDialog>
                                ...
                                <AlertDialogContent className="max-h-[90vh] overflow-y-auto">
                                  <AlertDialogHeader>
                                    <AlertDialogTitle>
                                      Supprimer {learner.first_name}?
                                    </AlertDialogTitle>
                                    <AlertDialogDescription>
                                      Cette action est irréversible et supprimera définitivement le
                                      compte et le profil de l'apprenant.
                                    </AlertDialogDescription>
                                  </AlertDialogHeader>
                                  <AlertDialogFooter>
                                    <AlertDialogCancel>Annuler</AlertDialogCancel>
                                    <AlertDialogAction
                                      onClick={() => handleDeleteUser(learner.id)}
