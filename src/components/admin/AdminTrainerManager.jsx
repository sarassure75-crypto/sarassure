...
const AdminTrainerManager = ({ onTrainerCreated }) => {
  ...
  const handleDeleteUser = async (userId) => {
    try {
      ...
      toast({
        ...
        description: "L'utilisateur et son profil ont été supprimés.",
        variant: 'destructive',
      });
      fetchTrainers();
    } catch (error) {
  ...
  const handleResetPassword = async (trainerId, trainerCode) => {
    ...
    try {
      ...
      toast({
        title: 'Erreur',
        description: `La réinitialisation a échoué: ${error.message}`,
        variant: 'destructive',
      });
    }
  };
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Voici la liste de tous les comptes formateurs et leurs codes uniques.
        </CardDescription>
      </CardHeader>
      <CardContent>
                        ...
                        <>
                          <TableCell>
                            <Input
                              ...
                              onChange={(e) =>
                                setEditedFields({ ...editedFields, first_name: e.target.value })
                              }
                            />
                          </TableCell>
                          <TableCell>
                            <Input
                              ...
                              onChange={(e) =>
                                setEditedFields({ ...editedFields, last_name: e.target.value })
                              }
                            />
                          </TableCell>
                          ...
                          <TableCell>
                            <Input
                              value={editedFields.pseudo}
                              onChange={(e) =>
                                setEditedFields({ ...editedFields, pseudo: e.target.value })
                              }
                            />
                          </TableCell>
                          <TableCell></TableCell>
                          <TableCell className="text-right">
                            <Button
                              variant="ghost"
                              size="icon"
                              onClick={() => handleSaveUser(trainer.id)}
                            >
                        ...
                        <>
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              {trainer.trainer_code && (
                                <Button
                                  ...
                                  size="icon"
                                  className="h-7 w-7"
                                  onClick={() => handleCopy(trainer.trainer_code, 'code')}
                                >
                          ...
                          <TableCell className="text-right space-x-1">
                            ...
                            <Button
                              variant="ghost"
                              size="icon"
                              onClick={() => handleResetPassword(trainer.id, trainer.trainer_code)}
