          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <div className="flex items-center space-x-2">
                ...
                <Select
                  value={task.pictogram_app_image_id || '_none_'}
      ...
      <AlertDialog open={showDeleteConfirm} onOpenChange={setShowDeleteConfirm}>
        <AlertDialogContent className="max-h-[90vh] overflow-y-auto">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Vous vous apprêtez à supprimer la tâche "<strong>{task.title}</strong>". Cette action
              la déplacera dans la corbeille mais elle pourra être restaurée.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
