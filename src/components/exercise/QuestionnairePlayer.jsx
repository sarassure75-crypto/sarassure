      ...
      console.log('✅ Questions loaded successfully:', {
        ...
        firstQuestion: processedQuestions[0]
          ? {
              ...
              choices: processedQuestions[0].choices.map((c) => ({
        ...
        <Card className="w-full border-2 border-blue-500">
          <CardContent className="pt-8 text-center">
            ...
            <h2 className="text-3xl font-bold mb-4 text-blue-900">
              Résultat: {finalScore.percentage}%
            </h2>
    ...
    <div className="flex flex-col w-full max-w-4xl mx-auto gap-4">
      ...
      <div className="flex gap-2 bg-white border-2 border-gray-300 rounded-lg p-3 shadow-md sticky top-0 z-10">
        ...
        <div className="relative ml-auto">
          ...
          {showTextZoomMenu && (
            <div className="absolute bg-white border-2 border-gray-300 rounded-lg shadow-xl z-50 min-w-[160px] top-full mt-2 right-0">
              <div className="p-2">
              ...
              return (
                ...
                >
                  ...
                  <div className="flex-1">
                    ...
                    {/* Texte de la réponse */}
                    {choice.text && (
                      <p className="text-base" style={{ fontSize: `${100 * textZoom}%` }}>
                        <HighlightGlossaryTerms text={choice.text} />
                      </p>
                    )}
                  </div>
