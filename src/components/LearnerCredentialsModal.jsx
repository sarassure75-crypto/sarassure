          ...
          <DialogContent className="sm:max-w-[425px] bg-gradient-to-br from-green-50 to-emerald-100 border-green-300">
            ...
            <div className="grid gap-6 py-6">
              <div className="flex items-center p-4 bg-white rounded-lg shadow border border-green-200">
                ...
                <Button variant="ghost" size="icon" className="ml-auto text-green-500 hover:text-green-700" onClick={() => handleCopy(currentUser.first_name, "Prénom")}>
              ...
              <div className="flex items-center p-4 bg-white rounded-lg shadow border border-green-200">
                ...
                <div>
                  ...
                  <p className="text-3xl font-bold tracking-wider text-green-700">{currentUser.learner_code}</p>
                </div>
                 <Button variant="ghost" size="icon" className="ml-auto text-green-500 hover:text-green-700" onClick={() => handleCopy(currentUser.learner_code, "Code Secret")}>
                  <Copy className="h-5 w-5" />
                </Button>
              </div>
            </div>
            <DialogFooter>
              <Button onClick={onClose} className="w-full bg-green-600 hover:bg-green-700">Fermer</Button>
            </DialogFooter>
          </DialogContent>
        </Dialog>
      );
