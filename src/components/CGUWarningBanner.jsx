      ...
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1">
          <div className="flex items-start justify-between gap-4">
            <div>
              <h3 className="font-semibold text-amber-900 mb-1">Conditions d'utilisation</h3>
              <p className="text-sm text-amber-800 mb-3">
                En soumettant votre contenu, vous acceptez nos Conditions Générales d'Utilisation
                (CGU). Veuillez lire nos conditions concernant la propriété intellectuelle et les
                droits d'auteur.
              </p>
              <button
                onClick={onReadMore}
