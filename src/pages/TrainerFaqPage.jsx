    ...
    >
      ...
      <Card className="mb-8 shadow-lg bg-gradient-to-br from-primary/10 via-background to-background">
        <CardHeader className="text-center">
          ...
          <CardDescription className="text-md md:text-lg text-muted-foreground mt-1">
            Trouvez des réponses aux questions fréquentes et des solutions aux difficultés
            rencontrées.
          </CardDescription>
        </CardHeader>
        <CardContent>
      ...
      {isLoading ? (
            ...
            >
              ...
              >
                <AccordionTrigger className="p-4 md:p-5 text-left hover:no-underline">
                  <span className="text-md md:text-lg font-medium text-primary">
                    {item.question}
                  </span>
                </AccordionTrigger>
        ...
        <p className="text-center text-muted-foreground py-8">
          Aucune Q&R ne correspond à votre recherche.
        </p>
      )}
      ...
      <Card className="mt-10 shadow-lg">
        <CardHeader>
          ...
          <CardDescription>
            Posez votre question ici. Elle sera ajoutée à la FAQ avec une réponse dès que possible.
          </CardDescription>
        </CardHeader>
        <form onSubmit={handleQuestionSubmit}>
          ...
          <CardFooter>
            <Button
              type="submit"
              className="w-full md:w-auto ml-auto bg-secondary hover:bg-secondary/90"
            >
